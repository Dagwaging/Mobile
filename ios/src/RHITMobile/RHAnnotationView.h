...
/// \ingroup map
/// The actual view to be rendered when an RHAnnotation appears on the map. This
/// type of MKAnnotationView is specifically used for showing the MapKit-like
/// text labeling locations on campus.
...
@property (nonatomic, strong) RHMapViewController *delegate;
...
/// useful here.
@property (unsafe_unretained, nonatomic, readonly) RHAnnotation *storedAnnotation;
...
@property (nonatomic, strong) RHMapLabel *textView;
