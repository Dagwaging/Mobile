...
namespace Rhit.Applications.Extentions.BindableApplicationBar {
    ...
    public class AppBar : ItemsControl, IApplicationBar {
        ...
        public static readonly DependencyProperty ModeProperty =
          DependencyProperty.RegisterAttached("Mode", typeof(ApplicationBarMode), typeof(BindableApplicationBar), new PropertyMetadata(true, OnModeChanged));
        ...
        public ApplicationBarMode Mode {
            get {
                return _applicationBar.Mode;
            }
            set {
                _applicationBar.Mode = value;
            }
        }
    }
}