...
/// 
/// The \link RhitMobile.InfoPage InfoPage \endlink contains all of the information pertinent to the given location.
...
/// \link RhitMobile.QuickListPage QuickListPage \endlink is just a simple list of \link RhitMobile.ObjectModel.RhitLocation RhitLocations \endlink that link back to the map with the selected location PushPin shown.
/// 
/// \subsection search_page Search Page (SearchPage)
/// \link RhitMobile.SearchPage SearchPage \endlink allows the user to search for both people and places with Rose-Hulman.
/// 
/// \subsection settings_page Application Settings Page (SettingsPage)
/// \link RhitMobile.SettingsPage SettingsPage \endlink allows the user to change several different options for the app.
